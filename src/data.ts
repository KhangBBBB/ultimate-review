...
6. Virtual-Memory Segmentation`,
            ...
            // Simple Paging.
            {
                question: "Why are page sizes typically chosen as a power of 2 in simple paging?",
                answer: "Page sizes are typically chosen as a power of 2 in simple paging to simplify the paging hardware."
            },
            {
                question: "What is an example of page addressing with a 16-bit address and 1K pages?",
                answer: "In a system with a 16-bit address and 1K pages, for example (010101 011011010): \n- Top 6 bits (010101) represent the page number \n- Bottom 10 bits (011011010) represent the offset within the page."
            },
            {
                question: "What are some common sizes for pages in simple paging?",
                answer: "Common sizes for pages in simple paging include 512 bytes, 1K, and 4K."
            },
            // Simple Segmentation.
            {
                question: "How does a program view memory in simple segmentation?",
                answer: "In simple segmentation, a program views memory as a set of segments of varying sizes."
            },
            {
                question: "What are some advantages of simple segmentation?",
                answer: "Advantages of simple segmentation include: \n- Supporting user view of memory \n- Easy handling of growing data structures \n- Facilitating sharing of libraries and memory \n- Applying privileges to a segment \n- Allowing programs to use multiple segments."
            },
            {
                question: "How is simple segmentation implemented?",
                answer: "Simple segmentation is implemented with segmentation tables, which consist of an array of base-limit register pairs. Each pair contains the beginning address (segment base), size (segment limit), and status bits (Present, Modified, Accessed, Permission, Protection)."
            },
            // Simple Segmentation.
            {
                question: "What are the components of a logical address in simple segmentation?",
                answer: "In simple segmentation, a logical address consists of two parts: a segment identifier and an offset that specifies the relative address within the segment."
            },
            {
                question: "What are the sizes of the segment identifier and the offset in simple segmentation?",
                answer: "The segment identifier is a 16-bit field called the Segment Selector, while the offset is a 32-bit field."
            },
            {
                question: "What are segmentation registers used for?",
                answer: "Segmentation registers are used to hold Segment Selectors for quick retrieval. The processor provides several segmentation registers: \n- cs (Code segment): points to a segment containing program instructions \n- ss (Stack segment): points to a segment containing the current program stack \n- ds (Data segment): points to a segment containing global and static data \n- es, fs, gs: additional segmentation registers for various purposes."
            },
            {
                question: "What additional information does the cs register contain in simple segmentation?",
                answer: "The cs register includes a 2-bit field that specifies the Current Privilege Level (CPL) of the CPU."
            },
            // Segmentation/Paging.
            {
                question: "What role does the CPU play in Pentium systems regarding memory addressing?",
                answer: "In Pentium systems, the CPU generates logical addresses."
            },
            {
                question: "What is the function of the segmentation unit in Pentium systems?",
                answer: "The segmentation unit produces a linear address from the logical address generated by the CPU."
            },
            {
                question: "What is the responsibility of the paging unit in Pentium systems?",
                answer: "The paging unit generates the physical address in memory from the linear address produced by the segmentation unit. It is equivalent to an MMU (Memory Management Unit)."
            },
            // Bonus.
            {
                question: "Compare and constrast segmentation and paging in the context of operating system.",
                answer: "Segmentation and paging are both memory management techniques used in operating systems to facilitate the efficient utilization of physical memory. Segmentation divides the logical address space into variable-sized segments, each representing a logical unit of a program such as code, data, or stack. Paging, on the other hand, divides the physical memory into fixed-sized blocks called pages and the logical address space into fixed-sized blocks called pages as well. While segmentation enables a more flexible memory allocation and protection mechanism, it suffers from external fragmentation. Paging, however, provides a more straightforward memory management approach, allowing for efficient use of physical memory with reduced fragmentation, albeit with some overhead due to the need for page table lookups. In essence, segmentation offers flexibility at the cost of fragmentation, while paging offers efficiency at the cost of additional overhead.",
            },
        ],
    },
    {
